...
int main(void)
{
    ...
    int T;       // Збереження елемента, що замінюєм іншим
    int d = 4;   // Відстань між елементами, що порівнюються
    int M[9][8] = {
    {  18,    3,   -3,   -2,  -20,   -3,    3,   -4 },
    {  -4,   14,   -7,    4,  -13,    7,  -18,  -15 },
    ...
    // Алгоритм Шелла для кожного рядка
    for (int i = 0; i < a; i++)
    {
...
void ShellAlg(int d, int a, int b, int M[a][b], int T, int i)
{
    ...
    // Зменшення відстані між елементами, що порівнюються
    else
    {
